...
/*@author Panzer01*/
public class A89EjemploMatrices {
    public static void main(String[] args) {
        ...
        A89Persona personas[][] = new A89Persona[3][2];
        //2. Inicializamos los valores de la matriz de personas
        personas[0][0] = new A89Persona("Juan");
        personas[0][1] = new A89Persona("Armando");
        personas[1][0] = new A89Persona("Karla");
        personas[1][1] = new A89Persona("Laura");
        personas[2][0] = new A89Persona("Pedro");
        personas[2][1] = new A89Persona("Javier");
