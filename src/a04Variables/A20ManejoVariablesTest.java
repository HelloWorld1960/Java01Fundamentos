package a04Variables;

/**@author Panzer01*/
public class A20ManejoVariablesTest {
    public static void main(String[] args) {
        ...
        boolean booll2=true;
        System.out.println("Valor booll1: "+booll);
        System.out.println("Valor booll2: "+booll2);
        System.out.println("");
        ...
        //Variables short, tiene el tamaño de 2 bytes
        short s1=2;
